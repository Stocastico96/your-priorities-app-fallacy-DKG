        ...
        function (error, post, image) {
          if (post && image) {
            ...
            image.save().then(function (results) {
              sendPostUserImageActivity(
                req,
                "activity.post.userImage.updated",
                post,
                image,
                function (error) {
                  ...
                  deleteImage(
                    req.body.oldUploadedPostUserImageId,
                    function (error) {
                      if (error) {
                        res.sendStatus(500);
                      } else {
