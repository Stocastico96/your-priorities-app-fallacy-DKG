import{m as t,f as e,_ as a,n as i,j as o,e as r,E as n,x as s,i as l,t as c,k as d,u as v,l as m,N as b,o as p,L as g}from"./D6L_vX2p.js";
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const h=t(e);class y extends h{constructor(){super(...arguments),this.disabled=!1,this.active=!1,this.hideInactiveLabel=!1,this.badgeValue="",this.showBadge=!1}render(){const{ariaLabel:t}=this;return s` <button
      class="md3-navigation-tab ${r(this.getRenderClasses())}"
      role="tab"
      ...
      >${this.renderLabel()}
    </button>`}getRenderClasses(){return{"md3-navigation-tab--hide-inactive-label":this.hideInactiveLabel,"md3-navigation-tab--active":this.active}}renderBadge(){return this.showBadge?s`<md-badge .value="${this.badgeValue}"></md-badge>`:n}renderLabel(){const{ariaLabel:t}=this,e=t?"true":"false";return this.label?s` <span
          aria-hidden="${e}"
          class="md3-navigation-tab__label-text"
          >${this.label}</span
        >`:n}firstUpdated(t){super.firstUpdated(t);const e=new Event("navigation-tab-rendered",{bubbles:!0,composed:!0});this.dispatchEvent(e)}focus(){const t=this.buttonElement;t&&t.focus()}blur(){const t=this.buttonElement;t&&t.blur()}handleClick(){this.dispatchEvent(new CustomEvent("navigation-tab-interaction",{detail:{state:this},bubbles:!0,composed:!0}))}}a([i({type:Boolean})],y.prototype,"disabled",void 0),a([i({type:Boolean,reflect:!0})],y.prototype,"active",void 0),a([i({type:Boolean,attribute:"hide-inactive-label"})],y.prototype,"hideInactiveLabel",void 0),a([i()],y.prototype,"label",void 0),a([i({attribute:"badge-value"})],y.prototype,"badgeValue",void 0),a([i({type:Boolean,attribute:"show-badge"})],y.prototype,"showBadge",void 0),a([o("button")],y.prototype,"buttonElement",void 0);
/**
 * @license
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _=t(e);class x extends _{constructor(){super(...arguments),this.disabled=!1,this.type="text",this.isListItem=!0,this.href="",this.target=""}get isDisabled(){return this.disabled&&"link"!==this.type}willUpdate(t){this.href&&(this.type="link"),super.willUpdate(t)}render(){return this.renderListItem(s`
      <md-item>
        <div slot="container">
    ...
    `)}renderListItem(t){const e="link"===this.type;let a;switch(this.type){case"link":a=d`a`;break;case"button":a=d`button`;break;default:a=d`li`}const i="text"!==this.type,o=e&&this.target?this.target:n;return v`
      <${a}
        id="item"
        ...
        @focus=${this.onFocus}
      >${t}</${a}>
    `}renderRipple(){return"text"===this.type?n:s` <md-ripple
      part="ripple"
      for="item"
      ?disabled=${this.isDisabled}></md-ripple>`}renderFocusRing(){return"text"===this.type?n:s` <md-focus-ring
    ...
    `}onFocus(){-1===this.tabIndex&&this.dispatchEvent(m())}focus(){this.listItemRoot?.focus()}click(){this.listItemRoot?this.listItemRoot.click():super.click()}}x.shadowRootOptions={...e.shadowRootOptions,delegatesFocus:!0},a([i({type:Boolean,reflect:!0})],x.prototype,"disabled",void 0),a([i({reflect:!0})],x.prototype,"type",void 0),a([i({type:Boolean,attribute:"md-list-item",reflect:!0})],x.prototype,"isListItem",void 0),a([i()],x.prototype,"href",void 0),a([i()],x.prototype,"target",void 0),a([o(".list-item")],x.prototype,"listItemRoot",void 0);
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let z=class extends x{};z.styles=[w],z=a([c("md-list-item")],z);
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const $=new Set(Object.values(b));class k extends e{get items(){return this.listController.items}constructor(){super(),this.listController=new g({isItem:t=>t.hasAttribute("md-list-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>"rtl"===getComputedStyle(this).direction,deactivateItem:t=>{t.tabIndex=-1},activateItem:t=>{t.tabIndex=0},isNavigableKey:t=>$.has(t),isActivatable:t=>!t.disabled&&"text"!==t.type}),this.internals=this.attachInternals(),this.internals.role="list",this.addEventListener("keydown",this.listController.handleKeydown)}render(){return s`
      <slot
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let R=class extends k{};R.styles=[I],R=a([c("md-list")],R);
