import{m as a,f as e,_ as t,n as i,o,E as r,x as n,g as s,i as d,t as c,e as v}from"./CvosEVhd.js";
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const l=a(e);class b extends l{constructor(){super(...arguments),this.activeIndex=0,this.hideInactiveLabels=!1,this.tabs=[]}render(){const{ariaLabel:a}=this;return n`<div
 ...
 * SPDX-License-Identifier: Apache-2.0
 */;let h=class extends b{};h.styles=[m],h=t([c("md-navigation-bar")],h);
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const g=a(e);class p extends g{constructor(){super(...arguments),this.opened=!1,this.pivot="end"}render(){const a=this.opened?"true":"false",e=this.opened?"false":"true",{ariaLabel:t,ariaModal:i}=this;return n`
      <div
        aria-expanded="${a}"
        aria-hidden="${e}"
        aria-label=${t||r}
    ...
    `}getRenderClasses(){return v({"md3-navigation-drawer--opened":this.opened,"md3-navigation-drawer--pivot-at-start":"start"===this.pivot})}updated(a){a.has("opened")&&setTimeout(()=>{this.dispatchEvent(new CustomEvent("navigation-drawer-changed",{detail:{opened:this.opened},bubbles:!0,composed:!0}))},250)}}t([i({type:Boolean})],p.prototype,"opened",void 0),t([i()],p.prototype,"pivot",void 0);
/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let u=class extends p{};u.styles=[f,y],u=t([c("md-navigation-drawer")],u);
